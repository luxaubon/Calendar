...
(function($){
    ...
    $.fn.ical = function(options){
        $.fn.ical.defaults = {
           daynames: ['จันทร์', 'อังคาร', 'พุธ', 'พฤหัสบดี', 'ศุกร์', 'เสาร์', 'อาทิตย์'], //default short names for the days of the week
        ...
        */
        function createNavigation(obj, insdate){
            ...
            obj.append("<div class='top-txt'><div class='top-txt-arrow'><img src='prev.png' id ='icalprev'></div><div class='mid-txt'><span id = 'currentmonth'>"+ options.monthnames[insdate.getMonth()] +"</span> <span id = 'currentyear'>"+ insdate.getFullYear() +"</span></div><div class='top-txt-arrow'><img src='next.png' id ='icalnext'></div></div>");
            //obj.append("<div class='top-txt'><div class='top-txt-arrow'><img src='./img/prev.png' id ='icalprev'></div><div class='mid-txt'><span id = 'currentmonth'>"+ options.monthnames[insdate.getMonth()] +"</span> <span id = 'currentyear'>"+ insdate.getFullYear() +"</span></div><div class='top-txt-arrow'><img src='./img/next.png' id ='icalnext'></div><div class='clock'><span id='hours'>"+hh+"</span>:<span id='minutes'>"+mm+"</span>:<span id='seconds'>"+ss+"</span></div></div>");
        ...
        */
        function createTable(obj){
           /* if (options.displayDaysInLastRow) {
            ...
            {
               $(".icaltable tr", obj).append("<th style='border: none;padding-bottom:10px'>"+ options.daynames[i] +"</th>"); //add the day header
            }
        };
            ...
            for (var i = 1; i <= days; i++) //each day in month
            {
                ...
                else
                {
					...
					for (var k = 0; k < jsondates.length; k++)
					{
						...
						//alert(datejson.type);
                        if(datejson.type == 1){
                            var str = "<li><div class='title'><img src='favicon.ico'><div class='titleTxT'>"+ datejson.title +"</div></div><!----><span class='desc'>"+ datejson.desc +"</span><div class='tm'><p>Time : "+ datejson.time +"</p><p>Detail : "+ datejson.place +"</p></div></li>"
                        /*}else if(datejson.type == 2){
                            var str = "<li><div class='title'><img src='img/green.png'><div class='titleTxT'>"+ datejson.title +"</div></div><!----><span class='desc'>"+ datejson.desc +"</span><div class='tm'><p>เน€เธงเธฅเธฒ : "+ datejson.time +"</p><p>เธชเธ–เธฒเธเธ—เธตเน : "+ datejson.place +"</p></div></li>"
                        */}else{
                             
                            var str = "<li><div class='title'><img src='orange.png'><div class='titleTxT'>"+ datejson.title +"</div></div><!----></li>"
